...
class Hyzllg:
    ...
    def insure_info(self):
        url = 'http://10.1.14.117:27405/channel/TEST/PPDAI/INSURE_INFO'
        data = {
                "channelCustId":"",
    ...
    def insure_data_query(self):
        url = 'http://10.1.14.117:27405/channel/TEST/PPDAI/INSURE_DATA_QUERY'
        data = {
    ...
    @wrapper
    def insure(self,a):
        url = 'http://10.1.14.117:27405/channel/TEST/PPDAI/INSURE'
        data = {
                "agentNo":"DingSheng",
                "agentName":"鼎盛保险经纪",
    ...
    def credit_granting(self):
        url = 'http://10.1.14.117:27405/channel/TEST/PPDAI/CREDIT_GRANTING'
        data = {
                "channelCustId":"",
                "insuranceNo":"2020082066566007",
    ...
    def credit_inquiry(self):
        url = 'http://10.1.14.117:27405/channel/TEST/PPDAI/CREDIT_INQUIRY'
        data = {
                    "channelCustId":"",
                    "creditReqNo":"2020082088588007"
                }
    ...
    @wrapper
    def disburse(self):
        url = 'http://10.1.14.117:27405/channel/TEST/PPDAI/DISBURSE'
        data = {
                    "channelCustId":"",
    ...
    def disburse_in_query(self):
        url = 'http://10.1.14.117:27405/channel/TEST/PPDAI/DISBURSE_IN_QUERY'
        data = {
                "channelCustId":"",
...
def main():
    ...
    HB_phone = phone()
    HB_bankcard = bankcard()
    hyzllg = Hyzllg(HB_loanReqNo,HB_creditReqNo,random__name,generate__ID,HB_phone,"5000","6",HB_bankcard,"建设银行",HB_phone)
