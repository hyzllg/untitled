...
def main():
    ...
    hyzllg = Hyzllg(HB_loanReqNo, random__name, generate__ID, HB_phone,"5000.00","6",HB_bankcard)
    # hyzllg = Hyzllg(HB_loanReqNo, random__name, "520526199704059451","15776631156","5000.00","6",HB_bankcard)
