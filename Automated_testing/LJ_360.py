...
class Hyzllg:
    def __init__(self, loanReqNo, name, idNo, phone, loanAmount, periods, bankcard,url):
...
def main(a):
    ...
    if a == 0:
        hyzllg = Hyzllg(HB_loanReqNo, random__name, generate__ID, HB_phone, "5000.00", "6", Bank,sit_url)
    elif a == 1:
        hyzllg = Hyzllg(HB_loanReqNo, random__name, generate__ID, HB_phone, "5000.00", "6", Bank, uat_url)
    elif a == 2:
        hyzllg = Hyzllg(HB_loanReqNo, random__name, generate__ID, HB_phone, "5000.00", "6", Bank, dev_url)
    else:
        print("........")
