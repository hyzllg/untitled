...
class Hyzllg:
    ...
    def credit_granting(self):
        ...
        url = 'http://10.1.14.106:27405/channel-dev/TEST/TCJQ/CREDIT_GRANTING'
        data = {
    ...
    def credit_inquiry(self):
        url = 'http://10.1.14.106:27405/channel-dev/TEST/TCJQ/CREDIT_INQUIRY'
        data = {
    ...
    def disburse_trial(self,capitalCode):
        url = 'http://10.1.14.106:27405/channel-dev/TEST/TCJQ/DISBURSE_TRIAL'
        data = {
            "channelCustId": "20200612886881021",
            "periods": 6,
            "loanAmount": "1000.00"
    ...
    def disburse(self,loanReqNo,capitalCode):
        url = 'http://10.1.14.106:27405/channel-dev/TEST/TCJQ/DISBURSE'
        data = {
                "channelCustId": "20200612886881021",
    ...
    def disburse_in_query(self,loanReqNo):
        url = 'http://10.1.14.106:27405/channel-dev/TEST/TCJQ/DISBURSE_IN_QUERY'
        data = {
                "channelCustId":"20200612886881021",
                "creditReqNo":"20200612668661021",
                "loanReqNo":"202006128866881022"
