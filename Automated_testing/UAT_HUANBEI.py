...
class Hyzllg:
    def __init__(self,loanReqNo,name,idNo,phone,loanAmount,periods,bankcard):
    ...
    def insure_info(self):
        url = 'http://10.1.14.117:27405/channel/TEST/HUANBEI/INSURE_INFO'
        data = {
                "channelCustId":"",
    ...
    def insure_data_query(self):
        url = 'http://10.1.14.117:27405/channel/TEST/HUANBEI/INSURE_DATA_QUERY'
        data = {
    ...
    @wrapper
    def insure(self,a):
        url = 'http://10.1.14.117:27405/channel/TEST/HUANBEI/INSURE'
        data = {
            "agentNo": "DingSheng",
            "agentName": "鼎盛保险经纪",
            "loanReqNo": "20200613910199001",
    ...
    @wrapper
    def disburse(self):
        url = 'http://10.1.14.117:27405/channel/TEST/HUANBEI/DISBURSE'
        data = {
            "channelCustId": "",
            "loanReqNo": "20200613910199001",
            "loanRate": 20.00,
...
def main():
    ...
    hyzllg = Hyzllg(HB_loanReqNo,random__name,generate__ID,HB_phone,"8000","6",HB_bankcard)
