...
![](E:\Pythonprojects\untitled\image\1593860199473.png)

![](E:\Pythonprojects\untitled\image\1593860216903.png)
...
![](E:\Pythonprojects\untitled\image\1593864795483.png)

定位一组元素的方法与定位单个元素的方法非常像，唯一的区别是单词“element”后面多了个“s”，用来表示复数。

![1593864874490](E:\Pythonprojects\untitled\image\1593864874490.png)

![1593864888778](E:\Pythonprojects\untitled\image\1593864888778.png)

运行结果：

![1593864909907](E:\Pythonprojects\untitled\image\1593864909907.png)
...
![1593865182586](E:\Pythonprojects\untitled\image\1593865182586.png)
...
![1593865615313](E:\Pythonprojects\untitled\image\1593865615313.png)![1593865625052](E:\Pythonprojects\untitled\image\1593865625052.png)
...
![1593866257114](E:\Pythonprojects\untitled\image\1593866257114.png)
...
+ select_by_index()：根据下拉选项的索引进行选择。第一个选项为0，第二个选项为1
  ...
  ![1593867058541](E:\Pythonprojects\untitled\image\1593867058541.png)

  通过WevDriver代码操作下拉框：

  ![1593867092932](E:\Pythonprojects\untitled\image\1593867092932.png)

  ![1593867122898](E:\Pythonprojects\untitled\image\1593867122898.png)
...
![1593867676439](E:\Pythonprojects\untitled\image\1593867676439.png)

![1593867720672](E:\Pythonprojects\untitled\image\1593867720672.png)

通过浏览器打开upfile.html文件，效果如图所示

![1593867765647](E:\Pythonprojects\untitled\image\1593867765647.png)

![1593867776351](E:\Pythonprojects\untitled\image\1593867776351.png)
...
![1593868058374](E:\Pythonprojects\untitled\image\1593868058374.png)

​		为了能在Firefox浏览器中实现文件的下载，我们需要通过FirefoxProfile()对其做一些设置。

![1593868122844](E:\Pythonprojects\untitled\image\1593868122844.png)

​		设置为0，表示文件会下载到浏览器默认的下载路径；设置为2，表示文件会下载到指定的目录。

![1593868184860](E:\Pythonprojects\untitled\image\1593868184860.png)
...
![1593868476249](E:\Pythonprojects\untitled\image\1593868476249.png)

Chrome浏览器在下载时默认不会弹出下载窗口，这里主要想修改默认的下载路径。

![1593868532830](E:\Pythonprojects\untitled\image\1593868532830.png)

设置为0，表示禁止弹出下载窗口

![1593868579095](E:\Pythonprojects\untitled\image\1593868579095.png)
...
+ delete_all_cookies()：删除所有Cookie
  ...
  ![1593869550026](E:\Pythonprojects\untitled\image\1593869550026.png)

  执行结果如下：

  ![1593869584666](E:\Pythonprojects\untitled\image\1593869584666.png)

  ![1593869600377](E:\Pythonprojects\untitled\image\1593869600377.png)

​        从执行结果可以看出，Cookie中的数据时以字典形式存放的。知道了Cookie中数据的存放形式后，即可按照这种形式向浏览器中添加Cookie

![1593870105754](E:\Pythonprojects\untitled\image\1593870105754.png)

​		执行结果如下：![1593870132848](E:\Pythonprojects\untitled\image\1593870132848.png)
...
![1593870497455](E:\Pythonprojects\untitled\image\1593870497455.png)

​		window.scrollTp()方法用于设置浏览器窗口滚动条的水平位置和垂直位置。第一个参数表示水平的左边距，第二个参数表示垂直的上边距，代码如下：

![1593870588010](E:\Pythonprojects\untitled\image\1593870588010.png)
...
![1593870806093](E:\Pythonprojects\untitled\image\1593870806093.png)

​		文本框的HTML代码如下：

![1593870829744](E:\Pythonprojects\untitled\image\1593870829744.png)

​		虽然可以通过id定位元素，但是不能通过send_keys()在文本框中输入文本信息。在这种情况下，可以借助JavaScript代码输入文本信息。

![1593870891483](E:\Pythonprojects\untitled\image\1593870891483.png)
...
![1593871388820](E:\Pythonprojects\untitled\image\1593871388820.png)
...
![1593871602893](E:\Pythonprojects\untitled\image\1593871602893.png)

​		当我们单击滑块时，改变的只是CSS样式，HTML代码段如下：
![1593871671602](E:\Pythonprojects\untitled\image\1593871671602.png)

​		slide-to-unlock-handle表示滑块。在滑动过程中，滑块的左边距离会逐渐变大，因为它在向右移动。

​		slide-to-unlock-progress表示滑过之后的背景色，背景色的区域会逐渐增加，因为滑块在向右移动。

![1593871807690](E:\Pythonprojects\untitled\image\1593871807690.png)
...
![1593871982101](E:\Pythonprojects\untitled\image\1593871982101.png)

​		另一种应用，上下滑动选择日期：

![1593872021148](E:\Pythonprojects\untitled\image\1593872021148.png)

​		参考前面的操作，通过ActionChains类可以实现上下滑动选择日期，但是这里要介绍另外一种方法，及通过TouchActions类实现上下滑动选择日期。

![1593872112058](E:\Pythonprojects\untitled\image\1593872112058.png)

![1593872120534](E:\Pythonprojects\untitled\image\1593872120534.png)
...
![1593872416646](E:\Pythonprojects\untitled\image\1593872416646.png)
