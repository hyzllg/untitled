...
def main_360(environment,number,loanAmount,periods,custGrde,capitalCode):
    ...
    res_url = get_yaml_data(f'{path}/conf/url_res/api_url_360.yaml')
    res_data = get_yaml_data(f'{path}/conf/loan_res/360_res_data.yaml')
    for i in range(number):
        ...
        #指定姓名身份证手机号时使用
        # name = "贯伦利"
        # idNo = "230826199104129353"
        # phone = "17849692791"
        # Bank = "6214660418155399"
